...
//     version 1.10.0
//     from Assets/PlayerInput/Input1.inputactions
//
...
{
    public InputActionAsset _asset { get; }
    public Input2()
    {
    ...
    ""controlSchemes"": []
        ...
        // UI
        m_UI = _asset.FindActionMap("UI", throwIfNotFound: true);
        ...
        // Playing
        m_Playing = _asset.FindActionMap("Playing", throwIfNotFound: true);
    ...
    {
        private Input2 m_Wrapper;
        public PlayingActions(Input2 wrapper) { m_Wrapper = wrapper; }
